...
def get_random_symptoms():
    ...
    # Add blood pressure and cholesterol level to symptoms list if they are not empty
    if blood_pressure:
...
def generate_random_name():
    # Add code to generate random names here
    # For example:
...
async def evaluation(request: Request):
    try:
        ...
        return JSONResponse(result),disease_name
