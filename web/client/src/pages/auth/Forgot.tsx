    ...
    <div className="flex flex-row flex-grow">
      ...
      <div className="flex items-center justify-center flex-grow p-6 lg:w-2/3 ">
        <div className="w-full max-w-md">
          <h2 className="flex flex-row mb-6 text-2xl font-bold">Reset password now <span> </span><img src='./assets/logo-dark.png' className='w-40 no-drag' alt='Police Connect' /></h2>
          <form>
            <div className="mb-6">
